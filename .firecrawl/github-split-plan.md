[Skip to content](https://github.com/citypaul/.dotfiles/blob/main/SPLIT-CLAUDE-MD-PLAN.md#start-of-content)

You signed in with another tab or window. [Reload](https://github.com/citypaul/.dotfiles/blob/main/SPLIT-CLAUDE-MD-PLAN.md) to refresh your session.You signed out in another tab or window. [Reload](https://github.com/citypaul/.dotfiles/blob/main/SPLIT-CLAUDE-MD-PLAN.md) to refresh your session.You switched accounts on another tab or window. [Reload](https://github.com/citypaul/.dotfiles/blob/main/SPLIT-CLAUDE-MD-PLAN.md) to refresh your session.Dismiss alert

{{ message }}

[citypaul](https://github.com/citypaul)/ **[.dotfiles](https://github.com/citypaul/.dotfiles)** Public

- [Notifications](https://github.com/login?return_to=%2Fcitypaul%2F.dotfiles) You must be signed in to change notification settings
- [Fork\\
68](https://github.com/login?return_to=%2Fcitypaul%2F.dotfiles)
- [Star\\
511](https://github.com/login?return_to=%2Fcitypaul%2F.dotfiles)
...
![citypaul](https://avatars.githubusercontent.com/u/5850178?v=4&size=40)![claude](https://avatars.githubusercontent.com/u/81847?v=4&size=40)

[citypaul](https://github.com/citypaul/.dotfiles/commits?author=citypaul)

and

[claude](https://github.com/citypaul/.dotfiles/commits?author=claude)

[Split CLAUDE.md into modular structure using imports (](https://github.com/citypaul/.dotfiles/commit/a0f84f0f6713118723e2469a35ddcb4c67de9d36) [#18](https://github.com/citypaul/.dotfiles/pull/18) [)](https://github.com/citypaul/.dotfiles/commit/a0f84f0f6713118723e2469a35ddcb4c67de9d36)

Open commit detailsfailure

4 months agoNov 1, 2025

[a0f84f0](https://github.com/citypaul/.dotfiles/commit/a0f84f0f6713118723e2469a35ddcb4c67de9d36) · 4 months agoNov 1, 2025

## History

[History](https://github.com/citypaul/.dotfiles/commits/main/SPLIT-CLAUDE-MD-PLAN.md)

Open commit details

[View commit history for this file.](https://github.com/citypaul/.dotfiles/commits/main/SPLIT-CLAUDE-MD-PLAN.md) History

376 lines (290 loc) · 12.7 KB
...
[Raw](https://github.com/citypaul/.dotfiles/raw/refs/heads/main/SPLIT-CLAUDE-MD-PLAN.md)
...
[Permalink: Plan: Split CLAUDE.md Into Modular Structure](https://github.com/citypaul/.dotfiles/blob/main/SPLIT-CLAUDE-MD-PLAN.md#plan-split-claudemd-into-modular-structure)
...
[Permalink: Research Findings](https://github.com/citypaul/.dotfiles/blob/main/SPLIT-CLAUDE-MD-PLAN.md#research-findings)

### Claude Code Import Syntax

[Permalink: Claude Code Import Syntax](https://github.com/citypaul/.dotfiles/blob/main/SPLIT-CLAUDE-MD-PLAN.md#claude-code-import-syntax)
...
**Documentation source**: [https://docs.claude.com/en/docs/claude-code/memory](https://docs.claude.com/en/docs/claude-code/memory)
...
[Permalink: Best Practices from Documentation](https://github.com/citypaul/.dotfiles/blob/main/SPLIT-CLAUDE-MD-PLAN.md#best-practices-from-documentation)
...
[Permalink: Current State](https://github.com/citypaul/.dotfiles/blob/main/SPLIT-CLAUDE-MD-PLAN.md#current-state)

**File**: `claude/.claude/CLAUDE.md` **Size**: 1,818 lines
**Sections**:
...
[Permalink: Proposed Structure](https://github.com/citypaul/.dotfiles/blob/main/SPLIT-CLAUDE-MD-PLAN.md#proposed-structure)
...
[Permalink: Main CLAUDE.md Structure (New)](https://github.com/citypaul/.dotfiles/blob/main/SPLIT-CLAUDE-MD-PLAN.md#main-claudemd-structure-new)
...
[Permalink: Example: Testing Section](https://github.com/citypaul/.dotfiles/blob/main/SPLIT-CLAUDE-MD-PLAN.md#example-testing-section)
...
[Permalink: Benefits](https://github.com/citypaul/.dotfiles/blob/main/SPLIT-CLAUDE-MD-PLAN.md#benefits)

### For Users

[Permalink: For Users](https://github.com/citypaul/.dotfiles/blob/main/SPLIT-CLAUDE-MD-PLAN.md#for-users)
...
[Permalink: For Maintenance](https://github.com/citypaul/.dotfiles/blob/main/SPLIT-CLAUDE-MD-PLAN.md#for-maintenance)
...
[Permalink: For Claude Code](https://github.com/citypaul/.dotfiles/blob/main/SPLIT-CLAUDE-MD-PLAN.md#for-claude-code)
...
[Permalink: Implementation Plan](https://github.com/citypaul/.dotfiles/blob/main/SPLIT-CLAUDE-MD-PLAN.md#implementation-plan)

### Phase 1: Extract Content (Preserve Everything)

[Permalink: Phase 1: Extract Content (Preserve Everything)](https://github.com/citypaul/.dotfiles/blob/main/SPLIT-CLAUDE-MD-PLAN.md#phase-1-extract-content-preserve-everything)
...
[Permalink: Phase 2: Update Main CLAUDE.md](https://github.com/citypaul/.dotfiles/blob/main/SPLIT-CLAUDE-MD-PLAN.md#phase-2-update-main-claudemd)
...
[Permalink: Phase 3: Verification](https://github.com/citypaul/.dotfiles/blob/main/SPLIT-CLAUDE-MD-PLAN.md#phase-3-verification)
...
[Permalink: Phase 4: Commit and Deploy](https://github.com/citypaul/.dotfiles/blob/main/SPLIT-CLAUDE-MD-PLAN.md#phase-4-commit-and-deploy)
...
[Permalink: Validation Criteria](https://github.com/citypaul/.dotfiles/blob/main/SPLIT-CLAUDE-MD-PLAN.md#validation-criteria)
...
[Permalink: Rollback Plan](https://github.com/citypaul/.dotfiles/blob/main/SPLIT-CLAUDE-MD-PLAN.md#rollback-plan)
...
[Permalink: Future Enhancements](https://github.com/citypaul/.dotfiles/blob/main/SPLIT-CLAUDE-MD-PLAN.md#future-enhancements)
...
[Permalink: Notes](https://github.com/citypaul/.dotfiles/blob/main/SPLIT-CLAUDE-MD-PLAN.md#notes)
...
[Permalink: Questions for Resolution](https://github.com/citypaul/.dotfiles/blob/main/SPLIT-CLAUDE-MD-PLAN.md#questions-for-resolution)
...
[Permalink: References](https://github.com/citypaul/.dotfiles/blob/main/SPLIT-CLAUDE-MD-PLAN.md#references)
