...
- [x] **LAYO-03**: Footer expands for active BioCharm component with help bar
- [x] **LAYO-04**: Footer contracts when component dismisses
- [x] **LAYO-05**: Terminal resize triggers layout recomputation without visual artifacts
