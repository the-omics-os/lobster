...
def _detect_data_type(adata: AnnData) -> Literal["single_cell", "bulk"]:
    """
...
# =============================================================================
# QC DEFAULTS BY DATA TYPE
# =============================================================================


def _get_qc_defaults(data_type: Literal["single_cell", "bulk"]) -> Dict[str, Any]:
    """
...
def create_shared_tools(
    ...
    def assess_data_quality(
        ...
        try:
            ...
            adata = data_manager.get_modality(modality_name)
            data_type = _detect_data_type(adata)
            defaults = _get_qc_defaults(data_type)
