...
class PipelineStrategyEngine:
    ...
    def get_pipeline_functions(
        ...
        # All pipelines now include _try_supplementary_first early in the chain
        # This handles datasets like GSE150825 with series-level 10x trio files
        # that need to be detected BEFORE attempting sample-level downloads
        pipeline_map = {
