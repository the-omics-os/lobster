    ...
    def concatenate(
        ...
        try:
            ...
            if hasattr(sample_data[0], "n_obs"):
                ...
                logger.info("Stage 1/3: Adding batch information to samples...")
                ...
                logger.info("Stage 1/3: Batch information added to all samples")

                # PROFESSIONAL PROGRESS LOGGING: Stage 2 - Memory estimation
                logger.info("Stage 2/3: Estimating memory requirements...")
                ...
                logger.info("  This may take 30-90s for large datasets (>100k cells)")
                logger.info("  Please wait - concatenation in progress...")
            ...
            # Handle DataFrames
                ...
                logger.info("Stage 1/3: Adding batch information to DataFrames...")
                ...
                logger.info("Stage 1/3: Batch information added to all DataFrames")
                ...
                logger.info("  This may take 30-90s for large datasets")
                logger.info("  Please wait - concatenation in progress...")
