...
class EntryProcessingOutcome:
    ...
    entry_id: str
    final_status: (
        str  # PublicationStatus value (e.g., "metadata_enriched", "handoff_ready")
    )
    ...
    step_results: Dict[str, bool] = field(
    ...
    def is_successful(self) -> bool:
        ...
        return self.final_status in ("metadata_enriched", "handoff_ready", "completed")
