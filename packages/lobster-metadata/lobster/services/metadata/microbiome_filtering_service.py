...
HOST_ALIASES = {
    "Human": [
        ...
        "human gut metagenome",  # Common in microbiome studies
        ...
        if allowed_sample_types:
            ...
            for sample_type in allowed_sample_types:
                if sample_type in self.SAMPLE_TYPE_ALIASES:
                    ...
                    raise ValueError(
                        "Sample type 'gut' is too ambiguous. "
                        "Please specify: 'gut_luminal_content' or 'gut_mucosal_biopsy'"
                    )
                else:
