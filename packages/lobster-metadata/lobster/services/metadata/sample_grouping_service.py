...
Addresses use case: "The sample can be correctly matched to an
...
class SampleGroupingService:
    ...
    def group_samples(
        ...
        """Alias for group_by_individual. Groups samples by individual_id."""
        return self.group_by_individual(samples, sort_by_timepoint=sort_by_timepoint)
