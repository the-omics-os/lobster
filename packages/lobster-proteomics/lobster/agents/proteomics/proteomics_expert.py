...
AGENT_CONFIG = AgentRegistryConfig(
    ...
    description="Mass spectrometry and affinity proteomics analysis: QC, normalization, differential expression",
    ...
    handoff_tool_description="Assign proteomics analysis tasks: MS/affinity QC, normalization, differential analysis",
    ...
    def find_differential_proteins(
        ...
        try:
            ...
            data_manager.store_modality(
                ...
                adata=de_adata,
                parent_name=modality_name,
                step_summary=f"DE analysis: {de_stats.get('n_significant', 0)} significant proteins",
            )
