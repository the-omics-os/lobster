...
lobster/config/providers/base_provider.py
lobster/config/providers/registry.py
...
# =============================================================================
# UI COMPONENTS (Always Open-Core - Rich CLI + Textual Dashboard)
# =============================================================================
...
# Textual UI (interactive dashboard)
lobster/ui/os_app.py
lobster/ui/commands.py
lobster/ui/screens/__init__.py
lobster/ui/screens/analysis_screen.py
lobster/ui/callbacks/__init__.py
lobster/ui/callbacks/textual_callback.py
lobster/ui/services/__init__.py
lobster/ui/services/error_service.py
lobster/ui/widgets/__init__.py
...
lobster/ui/widgets/queue_panel.py
lobster/ui/widgets/error_modal.py
lobster/ui/widgets/activity_log.py
lobster/ui/widgets/system_info.py
lobster/ui/widgets/token_usage_panel.py
lobster/ui/widgets/adapters_panel.py
lobster/ui/widgets/agents_panel.py
lobster/ui/widgets/connections_panel.py
...
# Commands - Split into light/heavy for performance (v0.4.0.7+)
lobster/cli_internal/commands/__init__.py
lobster/cli_internal/commands/output_adapter.py

# Light commands (fast startup, <100ms)
lobster/cli_internal/commands/light/__init__.py
lobster/cli_internal/commands/light/queue_commands.py
lobster/cli_internal/commands/light/metadata_commands.py
lobster/cli_internal/commands/light/workspace_commands.py
lobster/cli_internal/commands/light/pipeline_commands.py
lobster/cli_internal/commands/light/config_commands.py
lobster/cli_internal/commands/light/file_commands.py

# Heavy commands (data-intensive, lazy-loaded)
lobster/cli_internal/commands/heavy/__init__.py
lobster/cli_internal/commands/heavy/data_commands.py
lobster/cli_internal/commands/heavy/modality_commands.py
lobster/cli_internal/commands/heavy/visualization_commands.py
