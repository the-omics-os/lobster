...
Examples:
    ...
    # Show service responses and persist run metrics to JSON
    python tests/manual/test_publication_processing.py --ris-file path/to/publications.ris --show-response --max-entries 10 --output-file results/publication_run.json
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--ris-file",
        type=Path,
        default=None,  # No default - user must provide path
