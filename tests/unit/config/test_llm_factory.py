...
class TestModelTranslation:
    ...
    def test_translate_claude_3_7_sonnet(self):
        """Test translating Claude 3.7 Sonnet model ID."""
    ...
    def test_translate_claude_4_5_sonnet(self):
        """Test translating Claude 4.5 Sonnet model ID."""
    ...
    def test_translate_partial_match_3_7_sonnet(self):
        """Test translation with partial model name match for 3.7 Sonnet."""
        bedrock_id = "some-prefix-claude-3-7-sonnet-suffix"
        translated = LLMFactory._translate_model_id(
            bedrock_id, LLMProvider.ANTHROPIC_DIRECT
        )
        assert translated == "claude-3-5-sonnet-20241022"

    def test_translate_partial_match_4_5_sonnet(self):
        """Test translation with partial model name match for 4.5 Sonnet."""
        bedrock_id = "some-prefix-claude-sonnet-4-5-suffix"
        translated = LLMFactory._translate_model_id(
            bedrock_id, LLMProvider.ANTHROPIC_DIRECT
        )
        assert translated == "claude-3-5-sonnet-20241022"
