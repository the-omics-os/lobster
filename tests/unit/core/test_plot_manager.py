...
def test_add_plot_with_modality_context(plot_manager, mock_plotly_figure, sample_modalities):
...
def test_save_with_corrupted_plot_entry(plot_manager, mock_plotly_figure):
    ...
    plot_manager.latest_plots.append({"id": "corrupted", "title": "Bad"})  # Missing 'figure'
