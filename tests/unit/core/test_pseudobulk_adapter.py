...
class TestPseudobulkAdapterFromSource:
    ...
    def test_from_source_anndata(self, pseudobulk_adapter, valid_pseudobulk_adata):
        ...
        result = pseudobulk_adapter.from_source(
            valid_pseudobulk_adata, validate_schema=False
        )
...
class TestPseudobulkAdapterSampleParsing:
    ...
    def test_parse_pseudobulk_sample_ids_standard(self, pseudobulk_adapter):
        ...
        sample_ids = pd.Index(
            ["Sample_A_T_cell", "Sample_B_B_cell", "Sample_C_Monocyte"]
        )
    ...
    def test_parse_pseudobulk_sample_ids_complex(self, pseudobulk_adapter):
        ...
        assert (
            result.loc["Patient_001_Day_7_T_cell", "sample_id"] == "Patient_001_Day_7"
        )
...
class TestPseudobulkAdapterQualityMetrics:
    ...
    def test_get_quality_metrics_basic(
        self, pseudobulk_adapter, valid_pseudobulk_adata
    ):
    ...
    def test_get_quality_metrics_with_cell_counts(
        self, pseudobulk_adapter, valid_pseudobulk_adata
    ):
    ...
    def test_get_quality_metrics_diversity(
        self, pseudobulk_adapter, valid_pseudobulk_adata
    ):
    ...
    def test_get_quality_metrics_conditions(
        self, pseudobulk_adapter, valid_pseudobulk_adata
    ):
...
class TestPseudobulkAdapterPreprocessing:
    ...
    def test_calculate_pseudobulk_metrics(
        self, pseudobulk_adapter, valid_pseudobulk_adata
    ):
        """Test pseudobulk-specific metrics calculation."""
        result = pseudobulk_adapter._calculate_pseudobulk_metrics(
...
class TestPseudobulkAdapterFileLoading:
    ...
    def test_load_csv_pseudobulk_data(
        self, mock_read_csv, pseudobulk_adapter, pseudobulk_dataframe
    ):
    ...
    def test_load_excel_pseudobulk_data(
        self, mock_read_excel, pseudobulk_adapter, pseudobulk_dataframe
    ):
    ...
    def test_from_source_unsupported_format(self, pseudobulk_adapter):
        ...
        with patch.object(
            pseudobulk_adapter, "detect_format", return_value="unsupported"
        ):
...
class TestPseudobulkAdapterAggregation:
    ...
    def test_create_aggregated_data_missing_columns(self, pseudobulk_adapter):
        ...
        with pytest.raises(
            AdapterError, match="Cell type column 'cell_type' not found"
        ):
            pseudobulk_adapter.create_aggregated_data(
                single_cell_adata, "sample_id", "cell_type"
            )
...
class TestPseudobulkAdapterDesignValidation:
    ...
    def test_check_experimental_balance_balanced(
        self, pseudobulk_adapter, valid_pseudobulk_adata
    ):
