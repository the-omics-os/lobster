...
class TestProteomicsSurvivalService:
    ...
    def test_kaplan_meier_tertile_stratification(
        self, service, sample_adata_with_survival
    ):
    ...
    def test_kaplan_meier_quartile_stratification(
        self, service, sample_adata_with_survival
    ):
...
class TestProteomicsSurvivalServiceEdgeCases:
    ...
    def test_cox_regression_parallel_matches_sequential(self, service):
        ...
        assert (
            stats_seq["n_low_variance_skipped"] == stats_par["n_low_variance_skipped"]
        )
