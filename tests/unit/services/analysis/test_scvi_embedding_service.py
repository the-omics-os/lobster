...
class TestScviEmbeddingServiceBasics:
    ...
    def test_get_installation_message(self):
        ...
        assert ("✅ scVI is ready!" in message) or (
    ...
    def test_import_dependencies_fails_gracefully(self):
        ...
        service.availability_info = {
            ...
            "hardware_recommendation": {
                "device": "cpu",
                "command": "pip install scvi-tools",
                "info": "CPU (no GPU detected)",
            },
...
class TestScviEmbeddingServiceWithDependencies:
    ...
    def test_setup_device_cuda_available(self):
        ...
        with (
            patch.object(service, "_import_scvi_dependencies") as mock_import,
...
class TestScviTrainingIntegration:
    ...
    def test_train_scvi_embedding_with_batch_correction(self):
        ...
        mock_adata.obsm = {}
        mock_adata.uns = {}  # Add empty uns dict to avoid minification errors
        mock_adata.copy.return_value = (
            mock_adata  # Mock the copy method to return itself
        )
...
class TestErrorHandling:
    ...
    def test_service_with_import_error(self):
        ...
        with patch(
            "lobster.services.analysis.scvi_embedding_service.GPUDetector"
        ) as mock_detector:
    ...
    def test_invalid_parameters(self):
        ...
        # Test with None AnnData -- may raise ImportError if scVI not installed,
        # or TypeError/AttributeError if it is
...
class TestConditionalSkip:
    ...
    @pytest.mark.skipif(
        SCVI_AVAILABLE, reason="scVI is installed - testing unavailable scenario"
    )
